...
const double WHEEL_RADIUS = 0.095/2; // Wheel radius in meters
...
/*
double updateRateFactor = 30.0 / 100.0;     // Scale factor for 30 Hz update rate (It can adjusted based on desired update rate)
...
// Subscribe to ROS topics by move_base_simple/goal and /initial pose
